...
MOZ_RELEASE_CONSTINIT static StaticDataMutex<InstanceFunctionCache>
    sInstanceFnCache{"VulkanInstanceFunctions"};
...
#    endif
  ...
  if (!sVulkanEnumerated || !useCache) {
    ...
    strncpy(mNegotiatedVulkanDeviceName, validDevices[0].first.deviceName,
