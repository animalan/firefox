...
add_task(async function test_rowReuse() {
  ...
  // Wait for a couple of frames to ensure breakout-extend stops.
  // This will test if the caching based on the urlbar width works even
  // when the width changes due to breakout-extend (bug 2037933).
  for (let i = 0; i < 10; i++) {
